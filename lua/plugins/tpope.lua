return {
  -- embed git in vim/nvim, e.g. running `Git add %` will add the current file
  "tpope/vim-fugitive",
  ...
  -- adding 'tabstop', 'textwidth', 'endofline', 'fileformat', 'fileencoding', and
  -- 'bomb' to the list of supported options.
  "tpope/vim-sleuth",
}
